...
export const metadata: Metadata = {
  title: {
    default: 'Koffi AZOUGO – AI Systems & Full-Stack Engineer',
    template: '%s | Koffi AZOUGO'
  },
  description: 'Portfolio of Koffi AZOUGO – AI Systems & Agentic Engineer, Full-Stack Developer. Expert in LangGraph, CrewAI, MCP, Django, AWS. Available Remote/Hybrid.',
  keywords: ['AI Engineer', 'Agentic AI', 'LangGraph', 'CrewAI', 'MCP', 'LLM', 'Full-Stack', 'Python', 'Django', 'AWS', 'Portfolio', 'Koffi AZOUGO'],
  authors: [{ name: 'Koffi AZOUGO' }],
  creator: 'Koffi AZOUGO',
  openGraph: {
    type: 'website',
    locale: 'fr_FR',
    url: 'https://koffi-portfolio.vercel.app',
    title: 'Koffi AZOUGO – AI Systems & Full-Stack Engineer',
